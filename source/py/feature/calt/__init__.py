...
def get_calt(
    cls_var: ast.Clazz, cls_hex_letter: ast.Clazz, is_italic: bool, normal: bool = False, banner: list = []
) -> ast.Feature:
    return ast.Feature(
        "calt", banner + get_calt_lookup(cls_var, cls_hex_letter, is_italic, normal), "7.0"
    )

...
def fea(output: str, cn: bool) -> None:
    ...
    files = {
        "regular.fea": lambda: generate_fea_string(False, False),
        "italic.fea": lambda: generate_fea_string(True, False),
        "cn.fea": lambda: generate_fea_string_cn_only(),
    }
    ...
    files_cn = {
        "regular_cn.fea": lambda: generate_fea_string(False, True),
        "italic_cn.fea": lambda: generate_fea_string(True, True),
    }
    ...
    sections = {
        "<!-- CALT -->": lambda: f"```\n{get_all_calt_text()}\n```",
        "<!-- CV -->": lambda: get_cv_desc(),
        "<!-- CV-IT -->": lambda: get_cv_italic_desc(),
        "<!-- CV-CN -->": lambda: get_cv_cn_desc(),
        "<!-- SS -->": lambda: get_ss_desc(),
    }
